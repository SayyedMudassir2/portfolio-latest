    ...
    <section className="min-h-screen bg-gray-50 dark:bg-[#0f001a] pt-16 md:pt-32 px-4 sm:px-6 md:px-12 lg:px-20 pb-20">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-4 text-center">
          My <span className="bg-clip-text text-purple-600">Experience</span>
        </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-32 h-fit">
            <nav className="relative" aria-label="Experience timeline">
              ...
              <div
                aria-hidden="true"
                className="absolute left-1.5 top-6 bottom-0 w-1 bg-linear-to-b from-purple-500 to-slate-700 rounded-full"
            ...
            {experienceData.map((exp, idx) => (
              ...
              >
                ...
                <div className="space-y-4">
                  <h3
                    id={`exp-title-${exp.id}`}
                    className="text-3xl md:text-4xl font-bold text-black dark:text-white transition-colors"
                  >
                    {exp.title}
                  </h3>
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="bg-linear-to-r from-purple-600 to-purple-400 text-white px-4 py-1.5 rounded-full text-sm font-medium">
                      {exp.affiliation}
                    </span>
          ...
          bg-slate-200 text-purple-700 hover:bg-purple-200
          dark:bg-slate-800 dark:text-purple-300 dark:hover:bg-purple-900/50
        "
                      >
                        {skill}
                      </span>
